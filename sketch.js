...
gg = createSprite(displayWidth/2 , displayHeight/2 ,10,10);
gg.addImage(ggImg);
gg.visible = false;
...
taphere3 = createSprite(displayWidth/2  , displayHeight/2+200 , 10 ,10);
...
puzzle2reset = createSprite(displayWidth/2 , displayHeight/2 -50 , 10 ,10)
